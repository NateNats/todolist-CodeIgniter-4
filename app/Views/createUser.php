...
<form class="w-full max-w-sm">
  <div class="flex items-center border-b border-purple-500 py-2">
    ...
    <form action="/user2DB", method="post">
      <div>
        ...
        <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="password" aria-label="username" name="password">
